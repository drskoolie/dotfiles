...
set $ws104 "104: learn"   
set $ws105 "105: misc"   
set $ws106 "106: media 2"  
set $ws107 "107: torrent"    
set $ws108 "108: vpn"     
...
mode "ws0" {
	...
	bindsym l workspace number $ws104; mode "default"
 	bindsym m workspace number $ws105; mode "default"
	bindsym Shift+m workspace number $ws106; mode "default"
 	bindsym t workspace number $ws107; mode "default"
...
mode "cws0" {
	...
	bindsym l move container to workspace number $ws104; mode "default"
 	bindsym m move container to workspace number $ws105; mode "default"
	bindsym Shift+m move container to workspace number $ws106; mode "default"
 	bindsym t move container to workspace number $ws107; mode "default"
