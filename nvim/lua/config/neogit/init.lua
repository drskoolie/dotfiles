...
neogit.setup {
  ...
  --    tree = "https://github.com/${owner}/${repository}/tree/${branch}",
  --  },
  --  ["gitlab.com"] = {
  ...
  --    tree = "https://gitlab.com/${owner}/${repository}/-/tree/${branch}",
  --  },
  --  ["bitbucket.org"] = {
  ...
  --    tree = "https://bitbucket.org/${owner}/${repository}/src/${branch}",
  --  },
  --  },
