...
wk.add(
  {
    ...
    { "<leader>ae", group = "music" },
    { "<leader>aea", ':lua zellij_send_chars("abc2midi %:p -o %:p:r.mid")<CR>', desc = "abc2midi" },
    { "<leader>aet", ':lua zellij_send_chars("timidity %:p:r.mid")<CR>', desc = "timidity" },
    { "<leader>a", group = "apps" },
